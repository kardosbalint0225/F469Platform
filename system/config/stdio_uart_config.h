...
#define STDIO_UART_USARTx_IRQ_PRIORITY          14ul
#define STDIO_UART_DMAx_STREAMx_IRQn            DMA1_Stream3_IRQn
#define STDIO_UART_DMAx_STREAMx_IRQ_PRIORITY    14ul
