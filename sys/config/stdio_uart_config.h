...
#define STDIO_UART_TX_PIN_GPIOx_CLK_ENABLE      __HAL_RCC_GPIOB_CLK_ENABLE
#define STDIO_UART_RX_PIN_GPIOx_CLK_ENABLE      __HAL_RCC_GPIOB_CLK_ENABLE
#define STDIO_UART_TX_PIN_GPIOx_CLK_DISABLE     __HAL_RCC_GPIOB_CLK_DISABLE
#define STDIO_UART_RX_PIN_GPIOx_CLK_DISABLE     __HAL_RCC_GPIOB_CLK_DISABLE
