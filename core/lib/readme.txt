...
3.)  /core/lib/include/assert.h:
    ...
    3.3.) line 85: Removed preprocessor conditional (#elif defined(DEBUG_ASSERT_VERBOSE))
    3.4.) line 89-90: Removed the @note from _assert_failure function documentation 
    3.5.) line 102-135: Removed a large portion of comment from assert description since it does not hold 
...
8.)  /core/lib/include/debug.h:
    8.1.) line 27-29: FreeRTOS.h and core_config.h included, sched.h and thread.h are removed
    8.2.) line 38: modified the comment to task to be consistent with FreeRTOS task terminology
    8.3.) line 46: removed #include "cpu_conf.h"
    8.4.) line 47-57: modified DEBUG_PRINT to use the FreeRTOS API calls
        uxTaskGetStackSize is a FreeRTOS extension method defined in freertos_tasks_c_additions.h
    8.5.) line 77-78: removed #include "architecture.h" and modified the DEBUG_BREAKPOINT definition
    8.6.) line 135: DEBUG_EXTRA_STACKSIZE modified to use TASK_EXTRA_STACKSIZE 
9.)  /core/lib/include/list.h: modified the file name to ilist.h 
          Renaming this file is necessary because it would conflict with FreeRTOS list.h 
